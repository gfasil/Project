...
public class DataAccessFacade implements DataAccess {
	...
	static void loadAuthorMap(List<Author> memberList) {
		HashMap<String, Author> members = new HashMap<String, Author>();
		memberList.forEach(member -> members.put(member.getFirstName(), member));
		saveToStorage(StorageType.MEMBERS, members);
	}
	...
	public void saveNewAuthor1(HashMap<String,Author> a) {
		// TODO Auto-generated method stub
		
		saveToStorage(StorageType.AUTHORS,a);
